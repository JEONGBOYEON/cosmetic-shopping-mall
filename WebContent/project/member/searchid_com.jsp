...
<body>
 <div class="ap_wrapper">
	...
	<div class="page_title_area">
		<h1>아모레퍼시픽 뷰티포인트 통합 회원 아이디 찾기</h1>
	</div>
	...
	<div class="ap_contents find_id_pwd">
		...
		<div class="page_btns mgt15">
			<button type="button" onclick="location.replace('<%=cp %>/member/login.do')" class="btn_lg_primary w100p"><span>로그인 하러가기</span><i class="ico_arr_w"></i></button>
		</div>
	</div>
