		...
		<div class="ui_tab">
			<div class="tab_menu equally">
				<ul>
					...
					<li><a href="<%=cp %>/coupon/couponMyList.do">나만의 혜택</a></li>
				</ul>
			</div>
		</div>
						...
						<div class="coupon-section-coupon__btn-area">
							<c:choose>
								<c:when test="${empty sessionScope.customInfo.userId }">
									<button type="button" data-coupon-sn="2099" class="coupon-section-coupon__download-btn" onclick="javascript:location.href='<%=cp %>/member/login.do';"></button>
								</c:when>
								<c:otherwise>
