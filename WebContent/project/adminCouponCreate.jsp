...
<script type="text/javascript">
	...
	function couponSendIt(){
		...
		if(str!="HELLO"&&str!="FRIENDS"&&str!="PINKLOVE"){
			alert("\올바른등급을 입력하세요.\n[HELLO/FRIENDS/PINKLOVE]");//공백제거후 내용이 없으면
			f.couponGrade.focus();
			return;
		}
		...
		f.action = "<%=cp %>/coupon/created_ok.do";
		f.submit();
	...
	<div class="ap_contents product detail" style="padding-left: 150px;">
		...
		<form name="couponMyForm" action="<%=cp %>/coupon/created_ok.do" method="post">
		...
		<tr>
			<td colspan="2" align="center">
				<div class="purchase_button_set" style="padding-left: 200px;">
					...
					<span><button class="btn_lg_bordered emp btn_buy_now" type="button" onclick="javascript:location.href='<%=cp %>/coupon/adminList.do';">쿠폰 리스트</button></span>
