...
<script type="text/javascript">
	function sendIt() {
	    ...
	    f.action = "<%=cp%>/dest/updated_ok.do";
	    f.submit();
...
<tr>
	<td style="padding-left: 20px;" height="50">
		<input type="text" name="destZip" value="${dto.zip }" class="input_wrap w25p" style="padding: 10px 0px;">
		<input type="text" name="addr1" value="${dto.addr2 }" class="input_wrap w74p" style="padding: 10px 0px;">
	</td>
</tr>
<tr>
	<td style="padding-left: 20px;" height="50">
		<input type="text" name="addr2" value="${dto.addr2 }" class="input_wrap w100p" style="padding: 10px 0px;">
	</td>
</tr>
