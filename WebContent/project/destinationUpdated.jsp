    ...
    function sample2_execDaumPostcode() {
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                document.getElementById('destZip').value = data.zonecode;
...
<tr>
	...
	<td style="padding-left: 20px;">
	<input type="text" name="destZip" id="destZip" readonly="readonly" value="${dto.zip }" class="input_wrap w70p" style="padding: 10px 0px;">
